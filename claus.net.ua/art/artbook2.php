...
{$SERVER_ROOT = "http://claus.net.ua/art/artbook2.php";
...
$res=$db->query("SELECT title,meta_d,meta_k,text FROM general1 WHERE page='artbook2'");
      ...
      <tr>
        ...
        <td rowspan="2" class="tdC">
        	...
        	<?php include("../patr/cnttr.php"); ?>
                ...
                <div id='TexTcenter'>Рисунки (Photoshop, планшет и карандаш) Автор:Rigaard</div>
                <div class="artbd01">
                <?php 
						$res2=$db->query("SELECT * FROM artpreviewr WHERE selection='2d' ORDER BY date DESC");
						$i=0;
