<?php
	 if(!isset($login))
				...
				{
					$pass=$_POST['pass'];
					function myencryption2($phrase='',$leter,$number)
					{
						$phrase=md5($phrase);
					...
					if($userres->num_rows>0)
					{
						...
						if($currentuser['showmail']=='true'){$_SESSION['sesmail']=$currentuser['mail'];}else{$_SESSION['sesmail']='';}
                        $_SESSION['sesrequestmail']=$currentuser['mail'];
						$_SESSION['sescountry']=$currentuser['country'];
						$_SESSION['sescity']=$currentuser['city'];
						$_SESSION['seslevel']=$currentuser['level'];
                        $_SESSION['sesactivated']=$currentuser['activated'];
					}
					else
					{
						...
						if($currentuser2['showmail']=='true'){$_SESSION['sesmail']=$currentuser2['mail'];}else{$_SESSION['sesmail']='';}
